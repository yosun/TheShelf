...
public class PrimitivesDictionary : MonoBehaviour {
	...
	public static string SanitizeDictation(string s){
		...
		else if(s=="dodecahedron"||s=="doug decahedron"||s=="dodecahedral")return "Dodecahedron";
		else if(s=="decahedron"||s=="decahedron"||s=="decahedral")return "Decahedron";
		else if(s=="octahedron"||s=="octahedral")return "Octahedron";
