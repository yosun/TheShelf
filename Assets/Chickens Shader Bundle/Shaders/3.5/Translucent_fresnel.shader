Shader "Chickenlord/3.5/Reflective/Fresnel/Translucency"{
	Properties {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf BlinnPhongTranslucent fullforwardshadows addshadow novertexlights
		#pragma target 3.0
		...
		void surf (Input IN, inout SurfaceOutputPS o) {
			...
			o.ao = tex2D(_AO,IN.uv_MainTex).g;
			o.Emission += o.Albedo*ShadeSH9(float4(worldNormal,1))*o.ao;
			o.Indl = o.Albedo*ShadeSH9(float4(worldNormal*-1,1))*max(0,dot(normalize(IN.viewDir),o.Normal));
		}
		ENDCG
	} 
