Shader "Chickenlord/3.5/Reflective/Fresnel/Cook-Torrance Parallax Shaded Specular" {
Properties {
...
SubShader { 
	...
	inline half4 LightingCookTorrance_DirLightmap (SurfaceOutputPS s, fixed4 color, fixed4 scale, half3 viewDir, bool surfFuncWritesNormal, out half3 specColor)
	{
		UNITY_DIRBASIS
