Shader "Chickenlord/3.5/Toony/Transparent/Cutout/Lighted Outline Specularmap Sharp" {
	Properties {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf ToonyBlinnPhong alphatest:_Cutoff addshadow fullforwardshadows novertexlights
		#pragma target 3.0
