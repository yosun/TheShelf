Shader "Chickenlord/3.5/Toony/Transparent/Cutout/Outline Specularmap Sharp" {
	Properties {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf BlinnPhongPS alphatest:_Cutoff addshadow fullforwardshadows novertexlights
		#pragma target 3.0
