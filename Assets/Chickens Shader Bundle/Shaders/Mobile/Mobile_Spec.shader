Shader "Chickenlord/Mobile/Mod/Bumped Specular + Indirect Specular" {
Properties {
...
v2f_surf vert_surf (appdata_full v) {
  ...
  o.worldRefl = ShadeSH9(float4(normalize(reflect(worldRefl,worldN)),1))*_ISI;
  ...
  o.probes = ShadeSH9(float4(worldN,1))*2;
